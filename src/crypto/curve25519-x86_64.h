...
static bool curve25519_use_bmi2 __read_mostly;
static bool curve25519_use_adx __read_mostly;
...
static void curve25519_bmi2(u8 shared[CURVE25519_POINT_SIZE], const u8 private[CURVE25519_POINT_SIZE], const u8 session[CURVE25519_POINT_SIZE])
{
...
static void curve25519_bmi2_base(u8 session_key[CURVE25519_POINT_SIZE], const u8 private[CURVE25519_POINT_SIZE])
{
	__aligned(32) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];
	__aligned(32) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];
...
static void curve25519_adx(u8 shared[CURVE25519_POINT_SIZE], const u8 private[CURVE25519_POINT_SIZE], const u8 session[CURVE25519_POINT_SIZE])
{
	__aligned(32) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];
	__aligned(32) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];
	__aligned(32) u64 workspace[6 * NUM_WORDS_ELTFP25519_X64];
...
static void curve25519_adx_base(u8 session_key[CURVE25519_POINT_SIZE], const u8 private[CURVE25519_POINT_SIZE])
{
	__aligned(32) u64 buffer[4 * NUM_WORDS_ELTFP25519_X64];
	__aligned(32) u64 coordinates[4 * NUM_WORDS_ELTFP25519_X64];
	__aligned(32) u64 workspace[4 * NUM_WORDS_ELTFP25519_X64];
